...
;//! \htmlinclude EstimatedPose.msg.html

(cl:defclass <EstimatedPose> (roslisp-msg-protocol:ros-message)
  ((tx
    :reader tx
    :initarg :tx
    :type cl:float
...
(cl:defclass EstimatedPose (<EstimatedPose>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <EstimatedPose>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'EstimatedPose)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name realsense2_camera-msg:<EstimatedPose> is deprecated: use realsense2_camera-msg:EstimatedPose instead.")))

(cl:ensure-generic-function 'tx-val :lambda-list '(m))
(cl:defmethod tx-val ((m <EstimatedPose>))
...
(cl:defmethod ty-val ((m <EstimatedPose>))
...
(cl:defmethod tz-val ((m <EstimatedPose>))
...
(cl:defmethod rx-val ((m <EstimatedPose>))
...
(cl:defmethod ry-val ((m <EstimatedPose>))
...
(cl:defmethod rz-val ((m <EstimatedPose>))
  ...
  (rz m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <EstimatedPose>) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <EstimatedPose>) istream)
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<EstimatedPose>)))
  "Returns string type for a message object of type '<EstimatedPose>"
  "realsense2_camera/EstimatedPose")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'EstimatedPose)))
  "Returns string type for a message object of type 'EstimatedPose"
  "realsense2_camera/EstimatedPose")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<EstimatedPose>)))
  "Returns md5sum for a message object of type '<EstimatedPose>"
  "e46dd9c8f4990ebb7cf2458b8e07e095")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'EstimatedPose)))
  "Returns md5sum for a message object of type 'EstimatedPose"
  "e46dd9c8f4990ebb7cf2458b8e07e095")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<EstimatedPose>)))
  "Returns full string definition for message of type '<EstimatedPose>"
  (cl:format cl:nil "float64 tx~%float64 ty~%float64 tz~%float64 rx~%float64 ry~%float64 rz ~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'EstimatedPose)))
  "Returns full string definition for message of type 'EstimatedPose"
  (cl:format cl:nil "float64 tx~%float64 ty~%float64 tz~%float64 rx~%float64 ry~%float64 rz ~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <EstimatedPose>))
  (cl:+ 0
     8
     8
     8
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <EstimatedPose>))
  "Converts a ROS message object to a list"
  (cl:list 'EstimatedPose
    (cl:cons ':tx (tx msg))
    (cl:cons ':ty (ty msg))
    (cl:cons ':tz (tz msg))
    (cl:cons ':rx (rx msg))
